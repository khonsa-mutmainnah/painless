 ...
 * @author USER
 */
public class resultKiriTiga extends javax.swing.JFrame {

    /**
     * Creates new form resultKiriTiga
     */
    public resultKiriTiga() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(obatSatu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 390, -1, -1));

        obatSatu3.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        obatSatu3.setText("- aspirin");
        jPanel1.add(obatSatu3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 390, 70, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultKiriTiga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resultKiriTiga().setVisible(true);
            }
        });
    }
