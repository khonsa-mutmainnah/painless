 ...
 * @author USER
 */
public class resultKiriSatu extends javax.swing.JFrame {

    /**
     * Creates new form resultKiriSatu
     */
    public resultKiriSatu() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(solusiSatu, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 350, 310, -1));
        ...
        jPanel1.add(sebabDua2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, -1, -1));
        ...
        jPanel1.add(sebabDua, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 260, -1, -1));

        solusiSatu1.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        solusiSatu1.setText("- istirahat yang cukup ");
        jPanel1.add(solusiSatu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 390, 270, -1));

        solusiSatu2.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        solusiSatu2.setText("- lakukan peregangan sederhana");
        jPanel1.add(solusiSatu2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 420, 350, -1));

        solusiSatu4.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        solusiSatu4.setText("- perbanyak minum air putih");
        jPanel1.add(solusiSatu4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 450, 300, -1));

        solusiSatu3.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        solusiSatu3.setText("- jauhi gadget untuk sementara waktu");
        jPanel1.add(solusiSatu3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 480, 370, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultKiriSatu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resultKiriSatu().setVisible(true);
            }
        });
    }
