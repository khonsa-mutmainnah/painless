 ...
 * @author USER
 */
public class resultBelakangDua extends javax.swing.JFrame {

    /**
     * Creates new form resultBelakangDua
     */
    public resultBelakangDua() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(sebabSatu, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 170, -1, -1));
        ...
        jPanel1.add(solusiSatu, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 240, 270, -1));
        ...
        jPanel1.add(obatSatu, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 450, -1, -1));

        gewees.setFont(new java.awt.Font("Courier New", 1, 50)); // NOI18N
        gewees.setText("GET WELL SOON");
        jPanel1.add(gewees, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 590, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultBelakangDua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resultBelakangDua().setVisible(true);
            }
        });
    }
